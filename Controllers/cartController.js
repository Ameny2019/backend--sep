        ...
        try {
            ...
            if (cart) {
                ...
                if((productDetails.producType)==="estamp"){
                    ...
                    if(quantity < productDetails.estamp.QunatityEstampDisponible){ console.log("*****Qantité demandée estamp est accéptée vous pouvez continuer l'achat******")}
                    ...
                    console.log("***************Qantité demandée *********",quantity)
                    if(quantity <= productDetails.efleur.QunatityEfleurDisponible){ console.log("*****Qantité efleur demandée est accéptée vous pouvez continuer l'achat******")}
                    //------This removes an item from the the cart if the quantity is set to zero, We can use this method to remove an item from the list  -------
